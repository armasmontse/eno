...
// configuración SMTP
    ...
    protected $smtp_usr         = '5890848d102be1';
    protected $smtp_pswd        = '4ec9aa8b488139';
    protected $smtp_mail        = 'developer.sr@elcultivo.mx';
...
//----------------------------funciones para el envió del correo --------------------------------
    ...
    */
    ...
    protected function send($subject, $content, $headers = array(), $toEmail, $toName = '')
    {
        ...
        $headers = array_merge($mailsHead, $headers);

        return mail( $toName . '<' . $toEmail . '>', $subject, $content, implode("\r\n", $headers), '-f' . $toEmail);
    }
