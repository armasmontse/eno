...
class Cltvo_From_Here extends Cltvo_Metabox_Master
{
     ...
     */
    protected $description_metabox = "De aquí";
        ...
        <table class="ancho_100">
            <tr>
                <td >
                    ...
                    <input
                        type="text"
                        placeholder="<?= __("ingredientes de origen" ,TRANSDOMAIN) ?>"
                ...
                <td ALIGN="CENTER">
                    <div class="" style="    text-align: left;">
                        ...
                        <input
                            type="text"
                            placeholder="<?= __("De aquí" ,TRANSDOMAIN) ?>"
